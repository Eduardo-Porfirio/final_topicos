...
urlpatterns = [
    ...
    path('novo/', views.create_periodo_view, name='create_periodo'),
    path('editar/<int:pk>/', views.edit_periodo_view, name='edit_periodo'),
    path('excluir/<int:pk>/', views.delete_periodo_view, name='delete_periodo'),
